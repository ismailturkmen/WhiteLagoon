    ...
    public partial class addToDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "TESTESTSETSTSETSETSETSET", "https://placehold.co/600x400", "Royal Villa", 4, 200.0, 550, null },
                    { 2, null, "TESTESTESTSETSETSET", "https://placehold.co/600x401", "Premium Pool Villa", 4, 300.0, 550, null },
                    { 3, null, "TESTESTESTSETSET", "https://placehold.com/600x402", "Luxury Pool Villa", 4, 400.0, 750, null }
                });
